...
1. 讀取 `.claude/skills/ecpay/guides/16-go-live-checklist.md` 完整上線清單
2. 確認以下關鍵項目：
...
3. 若有金流 + 發票 + 物流整合，參考 `.claude/skills/ecpay/guides/11-cross-service-scenarios.md` 確認所有服務都已切換
4. 從 `.claude/skills/ecpay/references/` web_fetch 最新規格確認端點路徑無異動
