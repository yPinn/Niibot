...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <section className="flex flex-col gap-element">
      ...
      <div className="flex flex-col gap-element text-sub leading-relaxed text-muted-foreground">
        {children}
      </div>
    </section>
  )
      ...
      <div className="mx-auto max-w-2xl px-6 py-12 sm:px-10">
        ...
        <div className="flex flex-col gap-8">
          <Section title="1. 服務說明">
            <p>
              {SERVICE_NAME}（以下稱「本服務」）為一款 Twitch
              聊天機器人管理平台，提供自訂指令、自動回應、定時訊息、遊戲排隊、影片排隊等功能，協助
              Twitch 實況主管理聊天室互動。
            </p>
            <p>使用本服務前，請詳細閱讀以下條款。繼續使用即表示您同意本條款。</p>
          </Section>

          <Section title="2. 帳號與授權">
            <p>
          ...
          <Section title="5. 免責聲明">
            ...
            <p>本服務不對第三方平台（Twitch、YouTube 等）的政策變更所造成的功能影響負責。</p>
          </Section>
