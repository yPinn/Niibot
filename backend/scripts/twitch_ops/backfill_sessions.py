...
3. Creates session records from the VOD data
    ...
    npm run nb -- twitch backfill-sessions [--keep-existing] [--limit N]
    uv run --directory backend python -m scripts.twitch_ops.backfill_sessions [...]
"""
...
from scripts._lib import add_env_arg, ensure_backend_on_path, load_env, require_db_context
